        ...
        <form class="form">
            <div class="form-input">
                ...
                <div class="container-flex-input margin-top-x">
                    ...
                    <div class="align-v width-m-input margin-top-m ">
                        <label for="firstname"> <span class="label">First Nom </span><span class="asterisk"> *</span></label>
                        <input class="champs" id="firstname" type="text" name="firstname" class="margin-bot-l" placeholder="Nom">
                    </div>
                    <div class="align-v width-m-input margin-top-m ">
...
<script src="barProgress100.js"></script>
</body>
</html>
